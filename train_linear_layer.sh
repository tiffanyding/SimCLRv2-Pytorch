...
#SBATCH -t 0-24:00 # time requested (D-HH:MM)
...
# %j is jobid
#SBATCH -o /home/eecs/tiffany_ding/slurm_output/slurm.%N.%j.out # STDOUT
#SBATCH -e /home/eecs/tiffany_ding/slurm_output/slurm.%N.%j.err # STDERR
...
python train_linear_layer.py r152_3x_sk1.pth --num-workers 4 --num-epochs 5 --lr 0.5
